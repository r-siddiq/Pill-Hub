...
import com.pillhub.databinding.ActivityPrescriptionEntryBinding;

public class PrescriptionEntryActivity extends AppCompatActivity {
    private static final String PENTRY_ACTIVITY_USER_ID = "com.pillhub.PENTRY_ACTIVITY_USER_ID";
